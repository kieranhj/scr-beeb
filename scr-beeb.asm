...
_EXTEND_TRACK_DRAW_DISTANCE = TRUE
...
L_DBDA = $DBDA + BEEB_HAZEL_OFFSET		; COLOR RAM
L_DBDB = $DBDB + BEEB_HAZEL_OFFSET		; COLOR RAM
...
ZP_6B	= $6B + BEEB_ZP_OFFSET
ZP_6C	= $6C + BEEB_ZP_OFFSET
